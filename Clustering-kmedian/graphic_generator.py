...
def generate_plot_uniform_Poisson_sampling(plot_path_start, csv_path_list_M_Average, csv_path_list_M_Variance, csv_path_list_MoSChange_Average, csv_path_list_MoSChange_Variance, epsilon_list, plot_type, repetitions, include_title=True):
    ...
    for eps, csv_path_M_Average, csv_path_M_Variance, csv_path_MoSChange_Average, csv_path_MoSChange_Variance in zip(epsilon_list, csv_path_list_M_Average, csv_path_list_M_Variance, csv_path_list_MoSChange_Average, csv_path_list_MoSChange_Variance):
        ...
        plot_values_M_SD = np.sqrt(df_M_plot_Variance["stat_avg_cost"])*t_value/np.sqrt(repetitions)
        ...
        plot_values_MoSChange_SD = np.sqrt(df_MoSChange_plot_Variance["stat_avg_cost"])*t_value/np.sqrt(repetitions)
