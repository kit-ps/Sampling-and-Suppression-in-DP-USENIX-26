...
**This folder contains the code to generate the plots for our bound of Theorem 5.4**
...
The code generates the plots in Figures 2 and 4 (or 75 in the long version) for our paper.
...
The time to run is a couple of seconds. 
