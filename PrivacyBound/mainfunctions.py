...
def iteration(arg):
    ...
    if (value > th_value[1] + sens):
        print("\nLarger value at (", eps, ",", m_it, ",", M_it, "): ", value, "+", th_value, "diff:", Diff, "\n", diff_evol_result, flush=True)

    return [eps,m_it,M_it,DiffEvol,HypValue,Diff]

#### Iterations for epsilon==0 (done separately since functions are different)
def iteration_eps0(arg):
    m_it, M_it = arg
    ...
    return [0,m_it,M_it,DiffEvol,HypValue,Diff]