...
def paper_plots(database_name, column_name, main_folder_name, list_epsilons=[0.25,0.5,1,2], delta=None, numberofrepeat: int = 500):
    ...
    for mechanism_name in ["laplace","gaussian"]:
        ...
        generate_plot_uniform_Poisson_sampling(plot_path_start=plot_name_start, 
                        ...
                        epsilon_list=list_epsilons, plot_type=plot_type, error_type=error_type, mechanism_name=mechanism_name, numberofrepeat=500)
